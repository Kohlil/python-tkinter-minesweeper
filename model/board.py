...
class Board:
    ...
    def place_items(self):
        ...
        mines = Utility.randomly_distribute_values_2d((self.dif.x_size, self.dif.y_size), self.dif.max_mines, self.dif.min_mines)
        treasures = Utility.randomly_distribute_values_2d((self.dif.x_size, self.dif.y_size), self.dif.max_treasures, self.dif.min_treasures)
